...
return [
    ...
    'broadcasts' => [
        ...
        /*
        | מדדי מעורבות — מי פותח, מתי, ומתי להפסיק לשלוח.
        |
        | הכל נשען על אירועי הפתיחה שספק המייל מדווח. כשאין אירועים כאלה —
        | לא הוגדר Webhook, מעקב פתיחות כבוי — כולם נראים כמי שאינם פותחים,
        | ולכן אף כלל כאן אינו פועל בלי נתונים. היעדר מידע אינו ראיה.
        */
        'engagement' => [
            // חלון הזמן שממנו נלמד דפוס הפתיחה.
            'window_days' => env('BROADCAST_ENGAGEMENT_WINDOW_DAYS', 180),

            // מתחת לכמות הזו של פתיחות אין המלצת שעה — צירוף מקרים של חמש
            // פתיחות אינו "השעה שבה הלקוחות שלנו קוראים".
            'min_opens_for_advice' => env('BROADCAST_MIN_OPENS_FOR_ADVICE', 25),

            // דילוג על מי שלא פותח אף פעם. שליחה למי שאינו קורא אינה רק
            // מיותרת: שיעור פתיחה נמוך הוא מה שספקי הדואר מדרגים לפיו, והיא
            // פוגעת במסירה של כל השאר.
            'skip_non_openers' => [
                'enabled' => env('BROADCAST_SKIP_NON_OPENERS', true),
                // כמה הודעות נמסרו לו בלי פתיחה אחת לפני שמפסיקים.
                'min_sent' => env('BROADCAST_NON_OPENER_MIN_SENT', 5),
            ],
        ],
    ],
