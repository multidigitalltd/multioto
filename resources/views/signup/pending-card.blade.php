...
<head>
    ...
    <title>מאמתים את הכרטיס — מולטי דיגיטל</title>
...
<body>
    <main>
        <div class="icon">⏳</div>
        <h1>מאמתים את פרטי הכרטיס</h1>
        {{-- The redirect can beat the webhook. Saying "completed" here would
             promise a customer record that does not exist yet; saying "failed"
             would be wrong a moment later. --}}
        <p>קיבלנו את הפרטים ואנחנו מאמתים אותם מול חברת הסליקה. זה לוקח כמה שניות — אפשר לרענן את העמוד.</p>
        <a class="button" href="{{ route('signup.done', ['pending' => $pending->token]) }}">רענון</a>
