...
<head>
    ...
    <title>השלמת ההרשמה — הזנת כרטיס אשראי | מולטי דיגיטל</title>
...
<body>
    <main>
        ...
        @endif
        {{-- Said plainly, because it is now true: the customer record is created
             when the card is captured, not before. Somebody who leaves this page
             has not registered, and telling them otherwise would leave them
             believing they are a customer. --}}
        <p class="lead"><strong>זהו השלב האחרון</strong> — כרטיס הלקוח נפתח עם שמירת הכרטיס.</p>
