...
<head>
    ...
    <title>ההרשמה הושלמה — מולטי דיגיטל</title>
...
<body>
    <main>
        <div class="icon">🎉</div>
        <h1>ההרשמה הושלמה</h1>
        <p>תודה! כרטיס הלקוח נפתח ואנחנו כבר מתחילים לעבוד. שלחנו לכם מייל עם הפרטים.</p>
        <p>לכל שאלה — אפשר פשוט להשיב למייל או לכתוב לנו בוואטסאפ.</p>
