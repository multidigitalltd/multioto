...
<head>
    ...
    <title>לא ניתן להשלים כעת — מולטי דיגיטל</title>
...
<body>
    <main>
        ...
        <h1>לא ניתן להשלים את ההרשמה כרגע</h1>
        {{-- A card is required to open a customer, so an outage at the card
             provider stops the signup rather than opening a customer we could
             never collect from. The team is told, so nobody is left waiting
             for a call that was never triggered. --}}
        <p>אירעה תקלה זמנית מול חברת הסליקה ולא ניתן לקלוט כרגע פרטי כרטיס. הפרטים שמילאתם שמורים — אפשר לנסות שוב בעוד כמה דקות.</p>
        <p>הצוות שלנו קיבל על כך התראה וייצור איתכם קשר.</p>
        <a class="button" href="{{ route('signup.card', ['pending' => $pending->token]) }}">נסו שוב</a>
