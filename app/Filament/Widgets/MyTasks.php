...
class MyTasks extends BaseWidget
{
    ...
    protected static ?string $heading = 'משימות פתוחות';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('assignees.name')->label('אחראים')->badge()->placeholder('ללא שיוך'),
