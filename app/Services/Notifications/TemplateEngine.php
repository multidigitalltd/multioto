...
class TemplateEngine
{
    ...
    public const DEFAULTS = [
        ...
        'ticket.in_progress' => [
            'email' => [
                'subject' => 'התחלנו לטפל בפנייה שלך — פנייה #{{ticket_id}}',
                'body' => "שלום {{customer_name}},\n\nרצינו לעדכן שפנייתך \"{{ticket_subject}}\" (#{{ticket_id}}) נמצאת עכשיו בטיפול אצלנו.\nנעדכן אותך ברגע שיהיה חדש. אם בינתיים יש פרט נוסף שחשוב שנדע — פשוט השב להודעה זו.\n\nבברכה,\nצוות {{business_name}}",
            ],
            'whatsapp' => [
                'subject' => null,
                'body' => "שלום {{customer_name}}, הפנייה שלך (#{{ticket_id}}) בטיפול אצלנו כרגע 🛠️\nנעדכן אותך כאן ברגע שיהיה חדש.\n{{business_name}}",
            ],
        ],
        'ticket.resolved' => [
            'email' => [
