...
class Multioto_Agent_Mcp_Server
{
    ...
    private function toolDefinitions(): array
    {
        ...
        if (Multioto_Agent_Woo_Writer::active()) {
            $tools[] = ['name' => 'wc_product_search', 'description' => 'חיפוש מוצרים לפי טקסט חופשי (שם או מק"ט). מחזיר total (כמה מוצרים תואמים בסך הכל), returned (כמה הוחזרו כאן) ו-products — לכל אחד מזהה, שם, מק"ט, מחיר רגיל, מחיר מבצע ומלאי. השתמשו בזה כדי להפוך תיאור בדיבור ("החולצה השחורה") למזהה מוצר — וכשחוזרות כמה תוצאות, שאלו על איזה מהן מדובר במקום לנחש. אם total גדול מ-returned, אלה אינם כל המוצרים התואמים: אמרו זאת במפורש במקום לדבר עליהם כאילו הם כולם.', 'annotations' => $read, 'inputSchema' => ['type' => 'object', 'properties' => ['search' => ['type' => 'string'], 'limit' => ['type' => 'integer']], 'required' => ['search']]];
