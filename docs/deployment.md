...
| תור העבודה | פעימה שנייה, שרצה על התור הרגיל — היא שאומרת שהחיובים והחשבוניות באמת זזים. חלון ארוך יותר ומדווחת כ-`degraded` בלבד, כי גם עבודה ארוכה מעכבת אותה |
