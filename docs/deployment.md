...
| תור העבודה | פעימה שנייה, שרצה על התור הרגיל — היא שאומרת שהחיובים והחשבוניות באמת זזים. שקט של חצי שעה = `degraded` (ייתכן שרצה עבודה ארוכה); מעבר לשעה = `down`, כי אין עבודה שמותר לה לרוץ כל כך הרבה |
