...
📄 **התוכנית המלאה:** [docs/architecture.md](docs/architecture.md) · **תקן הפיתוח המחייב:** [docs/multi-digital-standard.md](docs/multi-digital-standard.md) · **כללי עבודה לקוד:** [CLAUDE.md](CLAUDE.md)
