...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        // The licence server our plugins call. Registered as API routes, not web
        // ones: the licence key is the whole authentication, and a session and a
        // CSRF token are two things an installed plugin cannot supply.
